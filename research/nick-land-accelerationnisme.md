# Nick Land — Accélérationnisme, CCRU et « Dark Enlightenment »

> Rapport de recherche documenté. Rédigé le 4 juin 2026. Sources en fin de document.
> Volet 7 : portrait dédié de l'autre « saint patron » controversé du manifeste d'Andreessen.
...
3. [Le CCRU et la « theory-fiction »](#3-le-ccru-et-la-theory-fiction)
4. [L'accélérationnisme : le capitalisme comme IA](#4-laccélérationnisme--le-capitalisme-comme-ia)
5. [Le tournant réactionnaire : Dark Enlightenment](#5-le-tournant-réactionnaire--dark-enlightenment)
6. [La controverse race/QI](#6-la-controverse-raceqi)
7. [Son influence sur la tech-right](#7-son-influence-sur-la-tech-right)
8. [Sources](#8-sources)
...
Andreessen liste **Nick Land** comme « saint patron du techno-optimisme ». Mais Land est aussi le **père de l'accélérationnisme** *et* un théoricien fondateur du courant **néo-réactionnaire / « Dark Enlightenment »**, ouvertement **anti-démocratique** et lié à la pseudo-science raciale. C'est sans doute la référence la plus sulfureuse du manifeste.

---

## 2. Biographie

**Nick Land**, né le **14 mars 1962** en Angleterre. Philosophe.
- **Doctorat (1987, Université d'Essex)** sur Heidegger (l'essai sur Trakl), sous David Farrell Krell.
- **Maître de conférences en philosophie continentale à l'Université de Warwick (1987-1998)**. Enseignant charismatique, marxiste deleuzien à ses débuts.
- **Fin des années 1990** : abus d'amphétamines, **effondrement (« breakdown »)** au début des années 2000, disparition de la vie publique.
- **Réémergence à Shanghai** (où il s'installe) comme **figure de la droite radicale** ; blogueur prolifique.

Œuvre majeure compilée : ***Fanged Noumena*** (2011), anthologie de ses textes des années 1990.

---

## 3. Le CCRU et la « theory-fiction »
...
## 4. L'accélérationnisme : le capitalisme comme IA
...
Avec Yarvin, il popularise cette « **race science** » (sans aucun généticien formé parmi ses sources). Les critiques (boundary2, Jules Evans, etc.) la qualifient de **racisme maquillé en science** et d'**idéalisme métaphysique**. C'est ce versant qui rend la canonisation de Land par Andreessen particulièrement problématique.

---

## 7. Son influence sur la tech-right

Land est un **nœud de diffusion** de l'idéologie néo-réactionnaire vers la Silicon Valley et le pouvoir :
- **Marc Andreessen** le cite comme « saint patron » (et est conseiller de la Maison-Blanche).
