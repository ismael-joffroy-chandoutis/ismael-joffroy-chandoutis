# Marc Andreessen's Techno-Optimist Manifesto — Analysis, Context, and Consequences

> Documented research report. Subject: *The Techno-Optimist Manifesto* (Marc Andreessen, a16z, October 16, 2023).
> Written June 4, 2026. Sources cited at the end of the document.
...
2. [Who is Marc Andreessen? Biography](#2-who-is-marc-andreessen-biography)
3. [a16z: the venture-capital machine](#3-a16z-the-venture-capital-machine)
4. [The manifesto: structure and theses](#4-the-manifesto-structure-and-theses)
5. [The ideological context: e/acc, futurism, TESCREAL](#5-the-ideological-context-eacc-futurism-tescreal)
6. [The "patron saints" and the "enemies"](#6-the-patron-saints-and-the-enemies)
7. [The criticisms](#7-the-criticisms)
8. [My analysis: implications and consequences for society](#8-my-analysis-implications-and-consequences-for-society)
...
On October 16, 2023, venture capitalist **Marc Andreessen** published on the website of his fund **Andreessen Horowitz (a16z)** a roughly **5,200-word** text titled *The Techno-Optimist Manifesto*. Made up of approximately **108 assertions** spread across **15 sections**, and hammered home by the anaphora "We believe," it defends a radical thesis: **technology, freed from all constraints, is the near-exclusive engine of human progress**, and anything that slows it down (regulation, ethics, "sustainability," the precautionary principle) amounts to moral betrayal.

The text is widely recognized as **the founding document of "effective accelerationism" (e/acc)**. It triggered an intense debate: hailed by part of Silicon Valley, it was also denounced as a **reactionary, elitist, and potentially dangerous ideology**, in particular because Andreessen lists as a "patron saint" the poet **Filippo Tommaso Marinetti**, co-founder of futurism *and* of the 1919 *Fascist Manifesto*, as well as the neo-reactionary philosopher **Nick Land**.

---

## 2. Who is Marc Andreessen? Biography

**Marc Lowell Andreessen** was born on **July 9, 1971** in Cedar Falls (Iowa) and grew up in New Lisbon (Wisconsin), in a modest family (his mother a customer-service operator at Lands' End, his father a sales manager at a seed company). He discovered programming at age 12.

- **Mosaic (1993).** A computer science student at the **University of Illinois at Urbana-Champaign** (graduated December 1993), he worked at the **National Center for Supercomputing Applications (NCSA)**. There, together with Eric Bina, he created **Mosaic**, the first mainstream browser to display images *inline* within the page. The impact was colossal: web traffic is said to have grown several-thousandfold in a single year. It is to him that we owe the convention of **hyperlinks in blue** (and purple once visited), still in use today.
- **Netscape (1994-1999).** He partnered with **Jim Clark** (founder of Silicon Graphics) to create Mosaic Communications, soon renamed **Netscape Communications**. The **Netscape Navigator** browser dominated the nascent web. **The 1995 IPO** made him a star: he appeared on the **cover of *Time*** at age 24, barefoot on a throne. In **1999, AOL acquired Netscape for $4.3 billion**.
- **Loudcloud / Opsware (1999-2007).** With **Ben Horowitz**, he co-founded Loudcloud (hosting and managed services), a pioneer of the cloud and of *software-as-a-service*, renamed Opsware, **acquired by Hewlett-Packard for $1.6 billion in 2007**.
- **Ning** (social networks), sold off around 2011 (~$150M).
- **Boards of directors.** He sits notably on the boards of **Facebook/Meta (since 2008)**, eBay (2008-2014), Hewlett Packard Enterprise (2008-2018, a controversial tenure: the failed Autonomy acquisition), Oculus VR, and others.
...
His political trajectory is striking: long a **Democratic donor** (Clinton, Gore, Kerry, Obama, Hillary Clinton), he swung to the right. In **July 2024**, he announced he was funding pro-**Trump** super PACs; he is a major backer of **Fairshake** (the crypto lobby). He justifies this shift by pointing to the Biden administration's hostility toward crypto, open-source AI, and the taxation of billionaires. In **2024-2025** he became an adviser to Trump, then was appointed to the **PCAST** (President's Council of Advisors on Science and Technology) in 2026.
...
## 4. The manifesto: structure and theses

The text is organized into **15 sections**:
*Lies; Truth; Technology; Markets; The Techno-Capital Machine; Intelligence; Energy; Abundance; Not Utopia, But Close Enough; Becoming Technological Supermen; Technological Values; The Meaning of Life; The Enemy; The Future; Patron Saints of Techno-Optimism.*

### Central theses (verbatim quotes)

**On technology**
- "Technology is the glory of human ambition and achievement, the spearhead of progress."
- "There is no material problem… that cannot be solved with more technology." (There is no material problem that cannot be solved with *more* technology.)

**On markets**
- "Markets are how we take care of people we don't know." (Markets are how we take care of strangers.)
- "Technological innovation in a market system is inherently philanthropic, by a 50:1 ratio." → **Market innovation is supposedly philanthropic by nature** (the "50:1 ratio").
...
**On population**
- "Our planet is dramatically underpopulated." (Our planet is dramatically *under*populated.)
- "The global population can quite easily expand to **50 billion people or more**." (The world's population could reach 50 billion inhabitants or more.)
...
## 5. The ideological context: e/acc, futurism, TESCREAL

### Effective accelerationism (e/acc)

The manifesto is considered **the manifesto of "effective accelerationism" (e/acc)**, a movement born within the Twitter/X scene after Elon Musk's acquisition (late 2022). The e/acc thesis: **technological innovation is philanthropic by nature**; rather than giving to charities, one should fund tech companies; any regulatory brake is harmful. e/acc positions itself as the **counterpoint to "effective altruism"** (effective altruism), discredited by the arrest of Sam Bankman-Fried (December 2022).
...
The substantive critique (notably from *Jacobin*) ties the text to a long tradition of **"aristocratic radicalism"**: the Nietzschean idea that "there exist natural elites destined to rule," that **"the production of the great men of culture is the telos of the species,"** and that the elite's progress **"must be paid for at the expense of the rest of us."** **Friedrich Hayek** is said to have modernized this idea by **replacing hereditary titles with wealth**: the market "discovers" superior individuals. e/acc would be its culmination: **unconstrained power for billionaires, dressed up in the vocabulary of markets**.
...
## 6. The "patron saints" and the "enemies"

### The 56 "Patron Saints of Techno-Optimism"

A heterogeneous list mixing scientists, classical-liberal/libertarian economists, and more problematic figures. Excerpts: **Ada Lovelace, John von Neumann, Richard Feynman, Stephen Wolfram, Ray Kurzweil** (science/tech); **Adam Smith, David Ricardo, Friedrich Hayek, Ludwig von Mises, Milton Friedman, Joseph Schumpeter, Thomas Sowell, Deirdre McCloskey, Paul Romer, William Nordhaus** (economics); **Friedrich Nietzsche, Filippo Tommaso Marinetti, Nick Land, John Galt** (Ayn Rand's character), **Vilfredo Pareto, James Burnham** (ideologically loaded figures).
...
**Favorable reactions.** Tech figures applauded: **Tobias Lütke** (Shopify), **Brian Armstrong** (Coinbase), **Steven Sinofsky**. The statistician **Nate Silver** said he agreed with about 84% of the 108 assertions, while rejecting accelerationism on the existential risk of AI.
...
## 8. My analysis: implications and consequences for society

### 8.1 What the text gets right

We have to be honest: **some of the premises are defensible**. Technology *has* indeed lifted billions of people out of poverty; systematic technological pessimism (dogmatic "degrowth") has a real human cost; and the argument that **slowing medical or energy innovation "costs lives"** is not absurd in the abstract. The manifesto captures genuine frustration with a certain **regulatory paralysis** ("vetocracy") and with an anti-tech climate. That is what explains its resonance.
...
This is the decisive point. The text presents as a **universal moral truth** what is **the commercial program of a venture-capital fund**. "All regulation is harmful," "market innovation is philanthropic 50:1," "slowing AI kills": these statements, beneath their prophetic garb, **mechanically maximize the value of a16z's portfolio** (crypto, AI, defense). When the same author **then funds super PACs** and becomes an **adviser to those in power**, the manifesto ceases to be an opinion: it becomes an **instrument of lobbying** that shapes public policy on AI and crypto.
...
The manifesto is **less a philosophy than a political act**. Its defensible part (technology is a major lever of progress) is instrumentalized in order to smuggle in a conclusion that does not follow: **"therefore, no safeguards."** The right answer is neither techno-pessimism nor Andreessen's techno-absolutism, but what *The Conversation* sums up well: **innovation *coupled* with democratic participation, pluralism, ethics, and respect for the environment.** Technological optimism deserves better than to be reduced to a billionaire's deregulatory agenda.
