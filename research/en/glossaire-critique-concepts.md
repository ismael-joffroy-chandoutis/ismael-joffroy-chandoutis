...
> Reference report. Written June 5, 2026. Sources at the end of the document.
> Part 12: a decoder for the series' key notions, each with an unapologetic **"bullshit or not?"** verdict. Designed to be read standalone or alongside the other parts.

---

## Contents
1. [Technocracy vs democracy](#1-technocracy-vs-democracy)
2. [Transhumanism](#2-transhumanism)
3. [Rationalism (in the Yudkowsky/LessWrong sense)](#3-rationalism-in-the-yudkowskylesswrong-sense)
4. [TESCREAL — the ideological "bundle"](#4-tescreal--the-ideological-bundle)
5. [Summary table: bullshit or not?](#5-summary-table-bullshit-or-not)
6. [Sources](#6-sources)
...
The **central** divide of the entire dossier. It is not about the *speed* of technology, but about **who decides, and on what grounds**.

| | **Democracy** | **Technocracy** |
|---|---|---|
| **Who decides?** | The greatest number, or **accountable** and **removable** institutions (parliaments, states, the UN) | A **small elite of "those who know"** (experts, engineers, insiders) |
| **Legitimacy drawn from…** | The **popular mandate**, the vote, public debate | **Expertise**, intelligence, mastery of the subject |
| **View of the public** | Sovereign, even when fallible | Too ignorant/irrational to decide |
...
**Definition:** a movement that seeks to **use technology to overcome human biological limits** (aging, death, disease, cognitive limits), up to creating an **augmented** or even **post-human** being.
...
## 3. Rationalism (in the Yudkowsky/LessWrong sense)

**Caution:** nothing to do with classical philosophical rationalism (Descartes, Spinoza). Here it is a **subcultural movement** born from the blog **LessWrong** (Yudkowsky, 2009).

**Definition:** the conviction that human thinking can be **"debugged"** to make better decisions, via:
- **Bayesian probability** (revising one's beliefs numerically with every new piece of evidence);
- the **hunt for cognitive biases**;
- **"first principles" reasoning** rather than reasoning from authority or tradition.
...
## 4. TESCREAL — the ideological "bundle"

A critical acronym coined by **Timnit Gebru** and **Émile P. Torres** to designate a **"bundle"** of intertwined Silicon Valley ideologies:

**T**ranshumanism · **E**xtropianism · **S**ingularitarianism · **C**osmism · **R**ationalism · **E**ffective Altruism · **L**ongtermism.

**The thesis:** these seven currents form **a single ensemble** with **shared roots** (including a **eugenicist genealogy**), the same **techno-utopian faith**, and the same tendency to **subordinate the present to a grandiose future** (galactic colonization, 10^58 future lives). Hence **elitist/authoritarian implications**, even when the discourse presents itself as humanist.

> TESCREAL is the **decoding tool** that links the parts together: transhumanism/crypto ([Part 4](./transhumanisme-crypto-convergences.md)), the caution camp ([Part 11](./camp-prudence-bengio-bostrom-yudkowsky.md)), counter-powers ([Part 10](./contre-pouvoirs.md)).

---

## 5. Summary table: bullshit or not?
